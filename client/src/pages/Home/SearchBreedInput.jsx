      ...
      <div className="flex justify-center mt-5">
        <div className="relative w-full max-w-md">
          <input
            ...
            type="text"
            placeholder={
              isLoading ? "Fetching breeds..." : "Search a dog breed..."
            }
            disabled={isLoading}
          ...
          {searchTerm && !isLoading && (
            <button
              onClick={handleReset}
              className="absolute right-0 top-1/2 -translate-1/2 p-1 hover:scale-125"
            >
              <X size={20} />
            </button>
          )}
          ...
          {showModal && (
            <BreedModal setShowModal={setShowModal} breed={currentBreed} />
          )}
        </div>
      </div>
    </>
